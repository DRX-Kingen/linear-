...
if __name__ == '__main__':
    ...
    sns.scatterplot(x='reading score', y='math score', data=data, label='Điểm đọc và điểm toán', color='blue')
    sns.scatterplot(x='writing score', y='math score', data=data, label='Điểm viết và điểm toán', color='green')
